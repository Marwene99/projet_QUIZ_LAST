...
// TESTE DE COMMIT
import com.projet.DAO.implementation.QuizDAO;
 ...
 * @author usager
 */
public class ListeQuiz extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Quiz> listeQu = new LinkedList<Quiz>();
        QuizDAO daol = new QuizDAO(Connexion.getInstance()); 
        listeQu = daol.findAll();
        
        Session.setAttribute("listeQu", listeQu);
        //la redirection vers ou ? 
